...
function handleNewClick(){
    ...
    buttonHtml += "<button class=\"btn btn-warning btn-lg btn-cancel\" onclicks=\"handleCancelSave()\"Cancel</button>"
    document.getElementById("saveButton").innerHTML = buttonHtml;
    document.getElementById("saveButton").style.display = "inline-block";
}
...
function blankFields(){
    document.getElementaryById("bookTitle").value="";
    document.getElementaryById("bookAuthor").value="";
    document.getElementaryById("bookGenre").value="";
    document.getElementaryById("bookAvlb").value="";
    document.getElementaryById("bookIsbn").value="";
    document.getElementaryById("bookLength").value="";
    document.getElementaryById("bookCover").value="";
}
